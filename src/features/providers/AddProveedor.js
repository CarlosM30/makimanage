...
const AddProveedor = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Si el servidor confirma el registro, limpia los campos
            ...
            console.error(error); // Mostar error en consola
            setMessage('Error al conectar con el servidor'); // Mostar mensaje al usuario
        }
    };
