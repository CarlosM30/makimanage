 ...
 * - Elegir un prodcuto existente o crear uno nuevo
 * - Especificar unidad, cantidad y fecha de caducidad
 * - Enviar datos al servidor para almacenar y actualizar información
 * 
 * @component
 * @returns {JSX.Element} Un formulario interactivo para gestionar productos
 */
const AddProduct = () => {
   ...
   * Carga la lista de categorías desde el servidor.
   *
   * @effect
   */
  useEffect(() => {
